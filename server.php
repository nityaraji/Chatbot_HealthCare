...
$db = mysqli_connect('localhost', 'root', '',  'HealthcareChatbot' /*'cond_instances'*/);
...
if (isset($_POST['createAccount'])) {
  ...
  $emailQuery = mysqli_query($db, "SELECT * FROM user WHERE email='$email'");
...
if (isset($_POST['login'])) {
  ...
  if (count($errors) == 0) {
    ...
    if (mysqli_num_rows($result) == 1) {
      ...
      $_SESSION['email'] = $result3->email_id;
